...
public class RadixUtil {
    ...
    @NonNull
    private static NumberFormatException forInputString(@NonNull String s) {
     ...
     */
    @NonNull
    public static long toNumber(@NonNull String s) {
        return toNumber(s, DIGIT.length);
    }

    @NonNull
    public static long toNumberLetter(@NonNull String s) {
     ...
     */
    @NonNull
    public static long toNumber(@NonNull String s, int radix) {
        if (s == null) {
