...
public class ZIPUtil {
    public static class Entry {
        ...
        public Entry(@NonNull String name, byte[] data) {
            this.Name = name;
            this.data = data;
        }
    }
    ...
    public static class ZipCompress {
        ...
        @NonNull
        public void compress(@NonNull Entry entry) throws IOException {
        ...
        public void compress(@NonNull List<Entry> entities) throws IOException {
            byte[] buf = new byte[1024];
    ...
    public static class ZipDeCompress {
        ...
        public byte[] deCompress(@NonNull String entryName) throws IOException {
    ...
    public static byte[] compress(@NonNull Entry entry) throws IOException {
        ZipCompress zc = new ZipCompress();
        zc.compress(entry);
        return zc.getBytes();
    }

    public static byte[] compress(@NonNull List<Entry> entries) throws IOException {
        ZipCompress zc = new ZipCompress();
        zc.compress(entries);
        return zc.getBytes();
    }
