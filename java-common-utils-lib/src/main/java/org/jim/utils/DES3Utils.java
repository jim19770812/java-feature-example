...
public class DES3Utils {
    ...
    public static byte[] encrypt(byte[] plantextBytes, @NonNull String key) throws Exception {
    ...
    @NonNull
    public static String decrypt(byte[] base64Bytes, @NonNull String key) throws Exception {
        SecretKey deskey = new SecretKeySpec(key.getBytes(), ALGORITHM);
        Cipher c1 = Cipher.getInstance(CIPHER_TRANSFORMAT);
