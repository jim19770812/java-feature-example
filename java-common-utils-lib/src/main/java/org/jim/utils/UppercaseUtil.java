...
public class UppercaseUtil {
     ...
     */
    @NonNull
    public static String changeDigit(@NonNull String str, @NonNull Boolean bo) {
     ...
     */
    @NonNull
    public static String readNumber(@NonNull String str, boolean bo) {
        StringBuffer strbu = new StringBuffer();
        if (str.length() != 4) {
            return null;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(changeNumberRMB(210));
    }
}
